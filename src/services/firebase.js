...
const firebaseConfig = {
  apiKey: "AIzaSyD4sd8xnlgUhuNV4Jn4lVtFttnN2jJcHfY",
  authDomain: "atenea-9ae5c.firebaseapp.com",
  projectId: "atenea-9ae5c",
  storageBucket: "atenea-9ae5c.appspot.com",
  messagingSenderId: "325002869963",
  appId: "1:325002869963:web:af5363d536095b28202f4e",
};
...
export async function getAllCharacters() {
  const docsSnap = await getDocs(collection(db, "characters"));

  const charactersData = docsSnap.docs.map((element) => {
...
export async function getCharacter(id) {
  ...
  const characterData = { id: docSnap.id, ...docSnap.data() };

  return characterData;
}

export async function getCharactersByCategory(category) {
  const collectionRef = collection(db, "characters");
  const categoryRef = query(collectionRef, where("category", "==", category));
  const docsSnap = await getDocs(categoryRef);

  const categoryData = docsSnap.docs.map((element) => {
    return { id: element.id, ...element.data() };
  });
...
export async function createBuyerOrder(orderData) {
...
export async function sendDataToFirebase() {
  const characters = [
    {
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/seiya.png",
    },
    {
      name: "Shiryū",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/shiryu.png",
    },
    {
      name: "Hyōga",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/hyoga.png",
    },
    {
      name: "Shun",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/shun.png",
    },
    {
      name: "Ikki",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/ikki.png",
    },
    {
      name: "Jabu",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/jabu.jpg",
    },
    {
      name: "Geki",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/geki.png",
    },
    {
      name: "Ban",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/ban.jpg",
    },
    {
      name: "Ichi",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/ichi.jpg",
    },
    {
      name: "June",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/june.jpg",
    },
    {
      name: "Nachi",
      category: "Bronce",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/nachi.jpg",
    },
    {
      name: "Marin",
      category: "Plata",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/marin.jpg",
    },
    {
      name: "Shaina",
      category: "Plata",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/shaina.jpg",
    },
    {
      name: "Misty",
      category: "Plata",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/misty.jpg",
    },
    {
      name: "Dio",
      category: "Plata",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/dio.jpg",
    },
    {
      name: "Jamian",
      category: "Plata",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/jamian.png",
    },
    {
      name: "Algethi",
      category: "Plata",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/algethi.jpg",
    },
    {
      name: "Mū",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/mu.jpg",
    },
    {
      name: "Aldebaran",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/aldebaran.jpg",
    },
    {
      name: "Saga",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/saga.jpg",
    },
    {
      name: "Deathmask",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/deathmask.jpg",
    },
    {
      name: "Aiolia",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/aiolia.png",
    },
    {
      name: "Shaka",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/shaka.jpg",
    },
    {
      name: "Dohko",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/dohko.png",
    },
    {
      name: "Milo",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/milo.png",
    },
    {
      name: "Aiolos",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/aiolos.png",
    },
    {
      name: "Shura",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/shura.jpg",
    },
    {
      name: "Camus",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/camus.png",
    },
    {
      name: "Aphrodite",
      category: "Oro",
      ...
      img: "https://ik.imagekit.io/83dwsxbtz/aphrodite.png",
    },
  ];
  ...
  for (let character of characters) {
    let resp = await addDoc(collectionRef, character);
